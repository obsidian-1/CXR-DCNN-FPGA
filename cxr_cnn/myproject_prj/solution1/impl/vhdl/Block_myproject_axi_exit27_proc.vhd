...
entity Block_myproject_axi_exit27_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Block_myproject_axi_exit27_proc is 
    ...
    signal tmp_data_V_0_preg : STD_LOGIC_VECTOR (19 downto 0) := "00000000000000000000";
    signal tmp_data_V_1_preg : STD_LOGIC_VECTOR (19 downto 0) := "00000000000000000000";
    signal tmp_data_V_2_preg : STD_LOGIC_VECTOR (19 downto 0) := "00000000000000000000";
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, io_acc_block_signal_op5)
    begin
        case ap_CS_fsm is
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, io_acc_block_signal_op5)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op5)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_ready_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op5)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    io_acc_block_signal_op5 <= (out_local_V_data_2_V_empty_n and out_local_V_data_1_V_empty_n and out_local_V_data_0_V_empty_n);
    ...
    out_local_V_data_0_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op5)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_1_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op5)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_2_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op5)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_0_V_dout, io_acc_block_signal_op5, tmp_data_V_0_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_0_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op5)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_1_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_1_V_dout, io_acc_block_signal_op5, tmp_data_V_1_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_1_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op5)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_2_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_2_V_dout, io_acc_block_signal_op5, tmp_data_V_2_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_2_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op5)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op5 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 

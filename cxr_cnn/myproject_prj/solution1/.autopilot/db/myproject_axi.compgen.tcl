...
# FIFO definition:
set ID 607
set FifoName start_for_Block_myproject_axi_exit27_proc_U0
set InstName start_for_Block_myproject_axi_exit27_proc_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0

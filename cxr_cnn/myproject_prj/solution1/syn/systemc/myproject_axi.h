...
#include "myproject.h"
#include "Block_myproject_axi_exit27_proc.h"
#include "Loop_2_proc.h"
#include "fifo_w8_d16384_A.h"
#include "fifo_w1_d2_A.h"
#include "fifo_w20_d1_A_x.h"
#include "fifo_w20_d2_A.h"
#include "start_for_myproject_U0.h"
#include "start_for_Block_myproject_axi_exit27_proc_U0.h"
...
struct myproject_axi : public sc_module {
    ...
    sc_signal< sc_logic > Loop_1_proc421_U0_ap_start;
    sc_signal< sc_logic > Loop_1_proc421_U0_ap_done;
    sc_signal< sc_logic > Loop_1_proc421_U0_ap_continue;
    sc_signal< sc_logic > Loop_1_proc421_U0_ap_idle;
    sc_signal< sc_logic > Loop_1_proc421_U0_ap_ready;
    sc_signal< sc_logic > Loop_1_proc421_U0_start_out;
    sc_signal< sc_logic > Loop_1_proc421_U0_start_write;
    sc_signal< sc_logic > Loop_1_proc421_U0_in_r_TREADY;
    sc_signal< sc_lv<8> > Loop_1_proc421_U0_in_local_V_data_0_V_din;
    sc_signal< sc_logic > Loop_1_proc421_U0_in_local_V_data_0_V_write;
    sc_signal< sc_lv<1> > Loop_1_proc421_U0_ap_return;
    ...
    sc_signal< sc_logic > myproject_U0_input_33_V_data_V_read;
    sc_signal< sc_lv<20> > myproject_U0_layer28_out_V_data_0_V_din;
    sc_signal< sc_logic > myproject_U0_layer28_out_V_data_0_V_write;
    sc_signal< sc_lv<20> > myproject_U0_layer28_out_V_data_1_V_din;
    sc_signal< sc_logic > myproject_U0_layer28_out_V_data_1_V_write;
    sc_signal< sc_lv<20> > myproject_U0_layer28_out_V_data_2_V_din;
    ...
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_ap_start;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_ap_done;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_ap_continue;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_ap_idle;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_ap_ready;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_out_local_V_data_0_V_read;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_out_local_V_data_1_V_read;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_out_local_V_data_2_V_read;
    sc_signal< sc_lv<20> > Block_myproject_axi_exit27_proc_U0_tmp_data_V_0;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_tmp_data_V_0_ap_vld;
    sc_signal< sc_lv<20> > Block_myproject_axi_exit27_proc_U0_tmp_data_V_1;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_tmp_data_V_1_ap_vld;
    sc_signal< sc_lv<20> > Block_myproject_axi_exit27_proc_U0_tmp_data_V_2;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_tmp_data_V_2_ap_vld;
    ...
    sc_signal< sc_lv<1> > start_for_Block_myproject_axi_exit27_proc_U0_din;
    sc_signal< sc_logic > start_for_Block_myproject_axi_exit27_proc_U0_full_n;
    sc_signal< sc_lv<1> > start_for_Block_myproject_axi_exit27_proc_U0_dout;
    sc_signal< sc_logic > start_for_Block_myproject_axi_exit27_proc_U0_empty_n;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_start_full_n;
    sc_signal< sc_logic > Block_myproject_axi_exit27_proc_U0_start_write;
    ...
    void thread_Block_myproject_axi_exit27_proc_U0_ap_continue();
    void thread_Block_myproject_axi_exit27_proc_U0_ap_start();
    void thread_Block_myproject_axi_exit27_proc_U0_start_full_n();
    void thread_Block_myproject_axi_exit27_proc_U0_start_write();
    void thread_Loop_1_proc421_U0_ap_continue();
    void thread_Loop_1_proc421_U0_ap_start();
    ...
    void thread_start_for_Block_myproject_axi_exit27_proc_U0_din();

...
#ifndef _Block_myproject_axi_exit27_proc_HH_
#define _Block_myproject_axi_exit27_proc_HH_
...
struct Block_myproject_axi_exit27_proc : public sc_module {
    ...
    sc_signal< sc_lv<20> > tmp_data_V_0_preg;
    sc_signal< sc_lv<20> > tmp_data_V_1_preg;
    sc_signal< sc_lv<20> > tmp_data_V_2_preg;

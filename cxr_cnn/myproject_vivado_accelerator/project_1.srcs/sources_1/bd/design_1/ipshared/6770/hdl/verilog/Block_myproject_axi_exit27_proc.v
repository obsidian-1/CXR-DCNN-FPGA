...
reg[19:0] tmp_data_V_0;
reg tmp_data_V_0_ap_vld;
reg[19:0] tmp_data_V_1;
reg tmp_data_V_1_ap_vld;
reg[19:0] tmp_data_V_2;
...
reg    ap_block_state1;
reg   [19:0] tmp_data_V_0_preg;
reg   [19:0] tmp_data_V_1_preg;
reg   [19:0] tmp_data_V_2_preg;
reg   [0:0] ap_NS_fsm;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 1'd1;
#0 tmp_data_V_0_preg = 20'd0;
#0 tmp_data_V_1_preg = 20'd0;
#0 tmp_data_V_2_preg = 20'd0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (io_acc_block_signal_op5 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        tmp_data_V_0_preg <= 20'd0;
    end else begin
        if ((~((ap_start == 1'b0) | (io_acc_block_signal_op5 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (io_acc_block_signal_op5 == 1'b0) | (ap_done_reg == 1'b1));
end

assign io_acc_block_signal_op5 = (out_local_V_data_2_V_empty_n & out_local_V_data_1_V_empty_n & out_local_V_data_0_V_empty_n);

endmodule //Block_myproject_axi_exit27_proc
